    ...
    var e = function() {
        ...
        function _(t) {
            var e = !!t && "length"in t && t.length
                , n = i.type(t);
            return "function" != n && !L(t) && ("array" == n || 0 === e || "number" == typeof e && e > 0 && e - 1 in t)
        }
        function q(t) {
        ...
        function H(t, i, r) {
            for (n in i)
                r && (R(i[n]) || M(i[n])) ? (R(i[n]) && !R(t[n]) && (t[n] = {}),
                M(i[n]) && !M(t[n]) && (t[n] = []),
                    H(t[n], i[n], r)) : i[n] !== e && (t[n] = i[n])
        }
        function U(t, e) {
        ...
        var e, n, i, r, O, P, o = [], a = o.concat, s = o.filter, u = o.slice, f = t.document, c = {}, l = {}, h = {
                "column-count": 1,
                columns: 1,
                "font-weight": 1,
                "line-height": 1,
                ...
                "z-index": 1,
                zoom: 1
            }, p = /^\s*<(\w+|!)[^>]*>/, d = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, m = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, g = /^(?:body|html)$/i, v = /([A-Z])/g, y = ["val", "css", "html", "text", "data", "width", "height", "offset"], b = ["after", "prepend", "before", "append"], x = f.createElement("table"), w = f.createElement("tr"), E = {
                ...
                th: w,
                "*": f.createElement("div")
            }, T = /^[\w-]*$/, S = {}, j = S.toString, C = {}, N = f.createElement("div"), A = {
                tabindex: "tabIndex",
                readonly: "readOnly",
                "for": "htmlFor",
                "class": "className",
            ...
            C.init = function(t, n) {
                ...
                if ("string" == typeof t)
                    ...
                    if (M(t))
                        ...
                        r = C.fragment(t.trim(), RegExp.$1, n),
                            t = null;
                    else {
                        if (n !== e)
                            return i(n).find(t);
        ...
        t.JSON && (i.parseJSON = JSON.parse),
            ...
            i.fn = {
                ...
                filter: function(t) {
                    return k(t) ? this.not(this.not(t)) : i(s.call(this, function(e) {
                ...
                not: function(t) {
                    ...
                    if (k(t) && t.call !== e)
                        ...
                        var r = "string" == typeof t ? this.filter(t) : _(t) && k(t.item) ? u.call(t) : i(t);
                ...
                parents: function(t) {
                    for (var e = [], n = this; n.length > 0; )
                        n = i.map(n, function(t) {
                            return (t = t.parentNode) && !F(t) && e.indexOf(t) < 0 ? (e.push(t),
                                t) : void 0
                        });
                    return U(e, t)
                },
                    ...
                    return "string" != typeof t || 1 in arguments ? this.each(function(e) {
                        if (1 === this.nodeType)
                            if ($(t))
                                ...
                                G(this, t, Y(this, i, e, this.getAttribute(t)))
                ...
                prop: function(t, e) {
                    return t = A[t] || t,
                        "string" != typeof t || 1 in arguments ? this.each(function(i) {
                            if ($(t))
                                for (n in t)
                                    this[A[n] || n] = t[n];
                            else
                ...
                offset: function(e) {
                    ...
                    if (!this.length)
                        return null;
                    if (f.documentElement !== this[0] && !i.contains(f.documentElement, this[0]))
                        return {
                            top: 0,
                            left: 0
                        };
                ...
                css: function(t, e) {
                    ...
                    var s = "";
                    if ("string" == D(t))
                        e || 0 === e ? s = I(t) + ":" + W(t, e) : this.each(function() {
                            this.style.removeProperty(I(t))
                        });
                    else
                        for (n in t)
                            t[n] || 0 === t[n] ? s += I(n) + ":" + W(n, t[n]) + ";" : this.each(function() {
                ...
                offsetParent: function() {
                    return this.map(function() {
                        for (var t = this.offsetParent || f.body; t && !g.test(t.nodeName) && "static" == i(t).css("position"); )
                            t = t.offsetParent;
                        return t
                    })
                }
            ...
            ["width", "height"].forEach(function(t) {
                ...
                i.fn[t] = function(r) {
                    var o, a = this[0];
                    return r === e ? L(a) ? a["inner" + n] : F(a) ? a.documentElement["scroll" + n] : (o = this.offset()) && o[t] : this.each(function(e) {
                        a = i(this),
    ...
    void 0 === t.$ && (t.$ = e),
            ...
            function y(t, n, r, o, a, u, f) {
                ...
                n.split(/\s/).forEach(function(n) {
                    ...
                    s.proxy = function(e) {
                        ...
                        s.i = p.length,
                        p.push(s),
                    "addEventListener"in t && t.addEventListener(v(s.e), s.proxy, g(s, f))
                })
            }
        ...
        function(e) {
            ...
            function T(t) {
                ...
                t && (t == c ? "html" : t == f ? "json" : s.test(t) ? "script" : u.test(t) && "xml") || "text"
            }
            function S(t, e) {
            ...
            function j(t) {
                ...
                !t.data || t.type && "GET" != t.type.toUpperCase() && "jsonp" != t.dataType || (t.url = S(t.url, t.data),
                    t.data = void 0)
            }
            function C(t, n, i, r) {
            ...
            function P(t, n, i, r) {
                ...
                e.each(n, function(n, u) {
                    ...
                    r && (n = i ? r : r + "[" + (s || "object" == o || "array" == o ? n : "") + "]"),
                        !r && a ? t.add(u.name, u.value) : "array" == o || !i && "object" == o ? P(t, u, i, n) : t.add(n, u)
                })
            }
            var r, o, n = +new Date, i = t.document, a = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, s = /^(?:text|application)\/javascript/i, u = /^(?:text|application)\/xml/i, f = "application/json", c = "text/html", l = /^\s*$/, h = i.createElement("a");
            h.href = t.location.href,
                e.active = 0,
                e.ajaxJSONP = function(r, o) {
                    if (!("type"in r))
                        return e.ajax(r);
                    var c, p, a = r.jsonpCallback, s = (e.isFunction(a) ? a() : a) || "Zepto" + n++, u = i.createElement("script"), f = t[s], l = function(t) {
                    ...
                    return o && o.promise(h),
                        e(u).on("load error", function(n, i) {
                            clearTimeout(p),
                                e(u).off().remove(),
                                "error" != n.type && c ? y(c[0], h, r, o) : b(null, i || "error", h, r, o),
                                t[s] = f,
                        ...
                        r.timeout > 0 && (p = setTimeout(function() {
                            l("timeout")
                        }, r.timeout)),
                            h)
                }
                ...
                e.ajax = function(n) {
                    ...
                    m(a),
                    a.crossDomain || (u = i.createElement("a"),
                        u.href = a.url,
                        u.href = u.href,
                        a.crossDomain = h.protocol + "//" + h.host != u.protocol + "//" + u.host),
                    ...
                    var c = a.dataType
                        , p = /\?.+=\?/.test(a.url);
                    if (p && (c = "jsonp"),
                    a.cache !== !1 && (n && n.cache === !0 || "script" != c && "jsonp" != c) || (a.url = S(a.url, "_=" + Date.now())),
                    "jsonp" == c)
                        return p || (a.url = S(a.url, a.jsonp ? a.jsonp + "=?" : a.jsonp === !1 ? "" : "callback=?")),
                            e.ajaxJSONP(a, s);
                    var N, d = a.accepts[c], g = {}, x = function(t, e) {
                        g[t.toLowerCase()] = [t, e]
                    }, C = /^([\w-]+:)\/\//.test(a.url) ? RegExp.$1 : t.location.protocol, O = a.xhr(), P = O.setRequestHeader;
                    if (s && s.promise(O),
                    a.crossDomain || x("X-Requested-With", "XMLHttpRequest"),
                        x("Accept", d || "*/*"),
                    (d = a.mimeType || d) && (d.indexOf(",") > -1 && (d = d.split(",", 2)[0]),
                        ...
                        O.onreadystatechange = function() {
                            if (4 == O.readyState) {
                                ...
                                if (O.status >= 200 && O.status < 300 || 304 == O.status || 0 == O.status && "file:" == C) {
                                    if (c = c || T(a.mimeType || O.getResponseHeader("content-type")),
                                    "arraybuffer" == O.responseType || "blob" == O.responseType)
                                        ...
                                        try {
                                            t = w(t, c, a),
                                                "script" == c ? (1,
                                                    eval)(t) : "xml" == c ? t = O.responseXML : "json" == c && (t = l.test(t) ? null : e.parseJSON(t))
                                        } catch (i) {
                                            n = i
                                        }
                                        if (n)
                                            return b(n, "parsererror", O, a, s)
                                    }
                                    y(t, O, a, s)
                                } else
                                    b(O.statusText || null, O.status ? "error" : "abort", O, a, s)
                            }
                        }
                        ,
                    v(O, a) === !1)
                    ...
                    if (O.open(a.type, a.url, A, a.username, a.password),
                        a.xhrFields)
                        for (o in a.xhrFields)
                            O[o] = a.xhrFields[o];
                    for (o in g)
                        P.apply(O, g[o]);
                    return a.timeout > 0 && (N = setTimeout(function() {
                        O.onreadystatechange = E,
                            O.abort(),
        ...
        function(t) {
            function e(t, e) {
                ...
                T && (i.ie = !0,
                    i.version = T[1]),
                j && (a || n.ios || l) && (i.safari = !0,
                n.ios || (i.version = j[1])),
                S && (i.webview = !0),
                    n.tablet = !!(s || b || o && !t.match(/Mobile/) || w && t.match(/Tablet/) || T && !t.match(/Phone/) && t.match(/Touch/)),
                    n.phone = !(n.tablet || n.ipod || !(o || f || c || g || v || x && t.match(/Android/) || x && t.match(/CriOS\/([\d.]+)/) || w && t.match(/Mobile/) || T && t.match(/Touch/)))
            }
        ...
        function(t, e) {
            ...
            o.style.transform === e && t.each(r, function(t, r) {
                return o.style[t + "TransitionProperty"] !== e ? (n = "-" + t.toLowerCase() + "-",
                    i = r,
                    !1) : void 0
            }),
                s = n + "transform",
                ...
                t.fn.anim = function(n, i, r, o, y) {
                    var b, w, S, x = {}, E = "", T = this, j = t.fx.transitionEnd, C = !1;
                    ...
                    "string" == typeof n)
                        ...
                        w = [];
                        for (b in n)
                            a.test(b) ? E += b + "(" + n[b] + ") " : (x[b] = n[b],
                                w.push(v(b)));
                        E && (x[s] = E,
                            w.push(s)),
                        i > 0 && "object" == typeof n && (x[u] = w.join(", "),
                            x[f] = i + "s",
                            x[l] = y + "s",
                            x[c] = r || "linear")
                    }
        ...
        function(e, n) {
            function s(t, i, r, o, a) {
                ...
                return o && (s.scale = o,
                    t.css(e.fx.cssPrefix + "transform-origin", "0 0")),
            ...
            t.when = function(i) {
                ...
                if (o > 1)
                    for (f = new Array(o),
                             c = new Array(o),
                             l = new Array(o); o > a; ++a)
                        r[a] && t.isFunction(r[a].promise) ? r[a].promise().done(h(a, l, r)).fail(u.reject).progress(h(a, c, f)) : --s;
                return s || u.resolveWith(l, r),
                    u.promise()
            }
                ,
                t.Deferred = n
        ...
        function(t) {
            ...
            e.qsa = function(i, r) {
                return f(r, function(o, a, f) {
                    try {
                        var c;
                        !o && a ? o = "*" : s.test(o) && (c = t(i).addClass(u),
                            o = "." + u + " " + o);
                        var l = n(i, o)
                    } catch (h) {
        ...
        function(e) {
            ...
            function x() {
                p && (e(document).off(h.down, f).off(h.up, c).off(h.move, l).off(h.cancel, v),
                    e(t).off("scroll", v),
                    v(),
                    p = !1)
            }
            function w(w) {
                var E, T, C, O, S = 0, j = 0;
                x(),
                    h = w && "down"in w ? w : "ontouchstart"in document ? {
                        down: "touchstart",
                        up: "touchend",
                        move: "touchmove",
                        cancel: "touchcancel"
                ...
                h && ("MSGesture"in t && (u = new MSGesture,
                    u.target = document.body,
                    e(document).bind("MSGestureEnd", function(t) {
                        var e = t.velocityX > 1 ? "Right" : t.velocityX < -1 ? "Left" : t.velocityY > 1 ? "Down" : t.velocityY < -1 ? "Up" : null;
                        e && (n.el.trigger("swipe"),
                            n.el.trigger("swipe" + e))
                    })),
                    f = function(t) {
                        (!(O = b(t, "down")) || y(t)) && (C = O ? t : t.touches[0],
                        t.touches && 1 === t.touches.length && n.x2 && (n.x2 = void 0,
                            n.y2 = void 0),
                            E = Date.now(),
                            T = E - (n.last || E),
                            n.el = e("tagName"in C.target ? C.target : C.target.parentNode),
                        i && clearTimeout(i),
                            n.x1 = C.pageX,
                            n.y1 = C.pageY,
                    ...
                    ,
                    l = function(t) {
                        (!(O = b(t, "move")) || y(t)) && (C = O ? t : t.touches[0],
                            g(),
                            n.x2 = C.pageX,
                            n.y2 = C.pageY,
                    ...
                    c = function(t) {
                        (!(O = b(t, "up")) || y(t)) && (g(),
                            n.x2 && Math.abs(n.x1 - n.x2) > 30 || n.y2 && Math.abs(n.y1 - n.y2) > 30 ? o = setTimeout(function() {
                                n.el && (n.el.trigger("swipe"),
                                ...
                                t.cancelTouch = v,
                                n.el && n.el.trigger(t),
                                    n.isDoubleTap ? (n.el && n.el.trigger("doubleTap"),
                    ...
                    ,
                    e(document).on(h.up, c).on(h.down, f).on(h.move, l),
